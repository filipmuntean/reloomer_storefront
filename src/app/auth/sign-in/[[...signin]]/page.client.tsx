  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signInAttempt.status === "complete") {
        ...
        // handling other statuses like mfa
        console.error(JSON.stringify(signInAttempt, null, 2));
        setError("Multi-factor authentication needed or other issue.");
      }
    } catch (err: any) {
      // https://clerk.com/docs/references/javascript/error-handling
  ...
  const handleGitHubLogin = () => {
    ...
    try {
      void signIn.authenticateWithRedirect({
        ...
        redirectUrlComplete: SYSTEM_CONFIG.redirectAfterSignIn,
